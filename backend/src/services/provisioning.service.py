...
class ProvisioningService:
    ...
    def create_subscriber(self, subscriber_data: Dict[str, Any], 
    ...
    def update_subscriber(self, uid: str, update_data: Dict[str, Any], 
                         mode: ProvisioningMode = ProvisioningMode.DUAL_PROV) -> ProvisioningResult:
        """
    ...
    def delete_subscriber(self, uid: str, 
                         mode: ProvisioningMode = ProvisioningMode.DUAL_PROV) -> ProvisioningResult:
        """
    ...
    def _get_from_legacy(self, uid: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            with connection.cursor() as cursor:
                cursor.execute(
                    "SELECT * FROM subscribers WHERE uid = %s AND status != 'DELETED'", 
                    (uid,)
                )
    ...
    def _detect_discrepancies(self, cloud_data: Dict[str, Any], 
