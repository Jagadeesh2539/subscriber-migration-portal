...
class MigrationController:
    ...
    def start_migration_job(job_id: str):
        ...
        try:
            ...
            audit_service.log_action(
                ...
                resource="migration",
                user=g.current_user.get("username", "system"),
                details={"job_id": clean_job_id, "execution_arn": result.get("execution_arn")},
            )

            return create_response(data=result, message=f"Migration job {clean_job_id} started successfully")
    ...
    def pause_migration_job(job_id: str):
        ...
        try:
            ...
            return create_response(data=result, message=f"Migration job {clean_job_id} paused successfully")
    ...
    def resume_migration_job(job_id: str):
        ...
        try:
            ...
            return create_response(data=result, message=f"Migration job {clean_job_id} resumed successfully")
    ...
    def cancel_migration_job(job_id: str):
        ...
        try:
            ...
            return create_response(data=result, message=f"Migration job {clean_job_id} cancelled successfully")
    ...
    def get_migration_status(job_id: str):
        ...
        try:
            ...
            return create_response(data=status, message="Migration status retrieved successfully")
    ...
    def list_migration_jobs():
        ...
        try:
            ...
            result = migration_service.list_migration_jobs(
                {"status": status_filter if status_filter != "all" else None, "limit": limit, "offset": offset}
            )
    ...
    def get_migration_metrics():
        ...
        try:
            ...
            return create_response(data=metrics, message="Migration metrics retrieved successfully")
    ...
    def estimate_migration():
        ...
        try:
            ...
            return create_response(data=estimation, message="Migration estimation completed")
    ...
    def export_migration_results(job_id: str):
        ...
        try:
            ...
            audit_service.log_action(
                ...
                resource="migration",
                user=g.current_user.get("username", "system"),
                details={"job_id": clean_job_id, "format": format_type, "record_count": export_data["record_count"]},
            )
    ...
    def retry_failed_records(job_id: str):
        ...
        try:
            ...
            return create_response(
                data=result, message=f"Retry initiated for {result.get('failed_records_count', 0)} failed records"
            )
    ...
    def get_system_compatibility():
        ...
        try:
            ...
            return create_response(data=compatibility, message="System compatibility check completed")
    ...
    def create_rollback_point(job_id: str):
        ...
        try:
            ...
            return create_response(data=rollback_result, message="Rollback point created successfully")
