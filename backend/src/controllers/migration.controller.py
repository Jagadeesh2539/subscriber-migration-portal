...
class MigrationController:
    ...
    def pause_migration_job(job_id: str):
        ...
        try:
            ...
            return create_response(
                data=result,
                message="Migration job paused successfully"
            )
    ...
    def resume_migration_job(job_id: str):
        ...
        try:
            ...
            return create_response(
                data=result,
                message="Migration job resumed successfully"
            )
    ...
    def get_migration_status(job_id: str):
        ...
        try:
            ...
            return create_response(
                data=result,
                message="Migration job status retrieved successfully"
            )
        ...
        try:
            ...
            audit_service.log_action(
                ...
                details={
                    ...
                    'audit_result': result.get('summary', {})
                }
            )
            
            return create_response(
                data=result,
                message="Migration audit completed successfully"
            )
        ...
        try:
            ...
            audit_service.log_action(
                ...
                details={
                    ...
                    'retry_result': result.get('summary', {})
                }
            )
            
            return create_response(
                data=result,
                message="Failed records retry completed"
            )
    ...
    def process_upload_and_create_job(file, target_system: str, job_name: str):
        ...
        try:
            ...
            return create_response(
                data=result,
                message="Upload processed and migration job created successfully"
            )
