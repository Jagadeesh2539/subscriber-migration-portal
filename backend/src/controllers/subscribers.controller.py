...
class SubscriberController:
    ...
    def bulk_operations():
        ...
        try:
            ...
            if operation == "delete":
                ...
                result = subscriber_service.bulk_delete(
                    subscriber_ids, soft_delete, prov_mode
                )
            else:
    ...
    def set_provisioning_mode():
        ...
        try:
            ...
            return create_response(
                data=result, message=f"Provisioning mode updated to {new_mode}"
            )
    ...
    def compare_systems():
        ...
        try:
            ...
            return create_response(
                data=result,
                message=(
                    f"System comparison completed - {result['summary']['accuracy']}% accuracy"
                ),
            )
