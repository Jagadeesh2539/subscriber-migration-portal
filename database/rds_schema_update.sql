...
-- MySQL 8.0 compatible schema for subscriber data
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_subscribers_provisioning_mode ON subscribers (provisioning_mode);
CREATE INDEX IF NOT EXISTS idx_subscribers_sync_status ON subscribers (sync_status);
CREATE INDEX IF NOT EXISTS idx_subscribers_activation_date ON subscribers (activation_date);
CREATE INDEX IF NOT EXISTS idx_subscribers_last_updated ON subscribers (last_updated);
...
CREATE INDEX IF NOT EXISTS idx_migration_jobs_status ON migration_jobs (job_status);
...
CREATE INDEX IF NOT EXISTS idx_migration_jobs_execution_arn ON migration_jobs (execution_arn);
...
CREATE INDEX IF NOT EXISTS idx_audit_source_system ON audit_log (source_system);
...
CREATE INDEX IF NOT EXISTS idx_plans_name ON plan_definitions (plan_name);
CREATE INDEX IF NOT EXISTS idx_plans_type ON plan_definitions (plan_type);
CREATE INDEX IF NOT EXISTS idx_plans_is_active ON plan_definitions (is_active);
...
CREATE EVENT IF NOT EXISTS cleanup_old_migration_jobs
...
CREATE EVENT IF NOT EXISTS reset_failed_login_attempts
ON SCHEDULE EVERY 1 DAY
DO
  UPDATE users 
